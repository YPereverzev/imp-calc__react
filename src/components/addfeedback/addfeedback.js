  ...
  return (
    <div className={styles.addFeedback}>
      <form
        ...
        onSubmit={(e) => handleSubmit(props.onSubmit, props.exporter, e)}
      >
        <fieldset>
          <legend className={styles.legend}>Leave your review</legend>

          <p>
            <label className={styles.form__label_name} for="user_name">
              Your name
            </label>
            <br></br>
          ...
          <p>
            <label className={styles.form__label_textarea} for="feedback_area">
              Your review
            </label>
            <br></br>
