import { LOAD_PRODUCTS, SUCCESS, REQUEST, FAILURE, ADD_PRODUCT } from '../constants';
...
const toObjProducts = (normalizedProducts) =>
  normalizedProducts.reduce((acc, product) => ({ ...acc, [product.id]: product }), {});
